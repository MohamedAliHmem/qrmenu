            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5 text-muted">
                        ...
                        @endphp
                        @if (!$telechargerFacture)
                            <p class="mt-3">Votre compte a été creé avec succès</p>
                        @endif
                                    ...
                                    <div class="p-2 mt-4">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <address>
                                                                    ...
                                                                    Date : <b>{{$abonnement->date_debut}}</b><br>
                                        ...
                                        @if (!$telechargerFacture)
                                            <div class="d-flex justify-content-between mt-4">
                                                ...
                                                <a href="/home" class="btn btn-primary">Accédez à votre compte</a>
                                            </div>
                                        @else
                                            <div class="mt-4">
                                                <a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-success">Retour</a>
                                            </div>
                                        @endif
